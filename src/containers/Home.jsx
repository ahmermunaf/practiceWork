...
class Home extends Component {
    ...
    //     this.contextTypes.parallaxController.update();
    // };
    render() {
        document.title = "Home";
        return (
                    ...
                    <div className="page-wrapper">
                        ...
                        >
                            ...
                            {/* <Parallax
                                ...
                                tag="figure"
                            > */}
                                <img src="./assets/images/main-slider/image-1.jpg" style={{height:'100%'}} />
                            {/* </Parallax> */}
                            </div>
                            <div>
                            {/* <Parallax
                                ...
                                // tag="figure"
                            > */}
                                <img src="./assets/images/main-slider/image-2.jpg" style={{height:'100%'}}/>
                            {/* </Parallax> */}
                            </div>
                        </Carousel>
                    </div>
                                ...
                                <div className="footer-column col-md-4 col-sm-12 col-xs-12" style={{width:'50%'}} >
                                    <div className="footer-widget news-widget" >
                                        ...
                                        <OverflowScrolling className='overflow-scrolling'>
                                            <article className="post" style={{paddingLeft:0}}>
                                            ...
                                            <article className="post" style={{paddingLeft:0,marginLeft:0}}>
